  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-50 to-white">
      ...
      <div className="max-w-lg mx-auto px-6 py-8">
        {/* Usage indicator + unlock button */}
        <div className="mb-6 flex flex-col gap-3">
          {!isSubscribed && (
            <div className="p-3 bg-pink-50 border border-pink-100 rounded-xl flex items-center justify-between">
          ...
          {!isSubscribed && (
            <button
              ...
              className="py-3 bg-pink-500 text-white rounded-xl font-medium text-base hover:bg-pink-600 transition-colors"
            >
              解锁 Pro，无限用 →
            </button>
          )}
